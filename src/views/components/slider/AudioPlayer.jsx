...
const AudioPlayer = ({ stopSong, pauseSong, resumeSong, audioControl }) => {
// const AudioPlayer = () => {
  // state
  ...
  return (
    <Wrapper className={styles.audioPlayer}>
      ...
      {/* progress bar */}
      <StyledProgressBar>
        <StyledInput type="range" className={styles.progressBar} defaultValue="0" ref={progressBar} onChange={changeRange} />
      </StyledProgressBar>
