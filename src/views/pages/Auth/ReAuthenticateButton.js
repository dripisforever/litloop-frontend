...
import { StyledConnectTwitch, StyledConnectYoutube, StyledConnectGoogle, StyledConnectSpotify, StyledConnectContainer, StyledReconnectIcon, } from './StyledComponents';
...
const GoogleBaseAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?
  client_id=${process.env.REACT_APP_YOUTUBE_CLIENT_ID}&
...
const SpotifyBaseAuthUrl = `https://accounts.spotify.com/authorize?
